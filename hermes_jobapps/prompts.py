...
def build_opportunity_prompt(
    ...
    return (
        ...
        "7. Author candidate-facing materials with native Hermes workbench tools: write_file/read_file/patch/search_files/terminal for files, edits, diffs, Typst/TeX compilation, and QA. Resume output should be Typst by default; cover letters can be TeX/Typst as appropriate.\n"
        ...
        "9. After the artifact is actually good, record minimal useful provenance: which requirement drove each material change, which proof point supports it, and what changed.\n"
        "10. Create follow-ups/progress items only for real external work such as sending outreach or a due follow-up. Do not create dashboard Actions or approvals for ordinary material review. Never perform an external submit/send/upload yourself.\n\n"
        "Expected artifacts:\n"
